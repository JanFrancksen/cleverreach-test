...
const Avvertrag = ({ formData }: FormValues) => (
  <main className="Content">
    <div className="ContentContainer mx-auto my-20 print:my-0">
      <Container>
        <Heading title="Vertrag zur Auftragsverarbeitung" size="3xl" tag="h1" />
        <p className="mb-6">
          ...
          eines Auftragverarbeitungsvertrages (AV-Vertrag).
        </p>
        <Heading title="Gegenstand der Verarbeitung" size="xl" tag="h2" bold />
        ...
        <ul className="mb-6 list-disc">
          {formData.personenstammdaten.toString().toLowerCase() === 'true' && (
            <li className="ml-8">Personenstammdaten</li>
          )}

          {formData.kommunikationsdaten.toString().toLowerCase() === 'true' && (
            <li className="ml-8">Kommunikationsdaten</li>
          )}
          {formData.vertragsstammdaten.toString().toLowerCase() === 'true' && (
            <li className="ml-8">Vertragsstammdaten</li>
          )}
        ...
        <ul className="mb-6 list-disc">
          {formData.kundenUndInteressierte.toString().toLowerCase() ===
            'true' && (
            <li className="ml-8">Kunden und Interessenten des Auftraggebers</li>
          )}
          ...
          {formData.sonstigeBetroffene.toString().toLowerCase() === 'true' && (
            <li className="ml-8">Sonstiges</li>
          )}
        </ul>
        <Heading
